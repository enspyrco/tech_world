...
**Production Plan prepared by:** Nicholas Meinhold
**Production Plan date:** 04/03/2026
...
| **Team Size** | 1 — sole developer, designer, and creative director. All technical, creative, and business responsibilities are handled by Nicholas Meinhold. Specialist contractors (sound design, accessibility audit) will be engaged for specific deliverables as outlined in the budget. |
...
|---|---|---|---|
| Gameplay capture & trailer assets | Apr 2026 | Nicholas Meinhold | Record polished gameplay footage for promotional use — multiplayer sessions, challenge solving, video chat, AI tutor interaction. Build a library of screenshots and short clips. |
| Steam page creation | May 2026 | Nicholas Meinhold | Create Steam store page with trailer, screenshots, description, and genre tags. Begin collecting wishlists. Position as "multiplayer coding adventure" in Indie/Puzzle/Education categories. |
| Dev log series | May–Sep 2026 | Nicholas Meinhold | Monthly dev log posts on Steam and social media documenting development progress, technical insights, and community feedback. Build audience and demonstrate momentum. |
| Social media presence | May–Oct 2026 | Nicholas Meinhold | Regular posts on X/Twitter, Reddit (r/indiegaming, r/gamedev, r/learnprogramming), and relevant Discord communities. Short gameplay clips, GIFs, and progress updates. |
| Create announcement trailer | Aug 2026 | Nicholas Meinhold | 60-second trailer showing the core gameplay loop — exploring, solving challenges, collaborating with other players via video, chatting with Clawd. Focus on what makes the experience unique. |
| PAX Aus announcement | Aug 2026 | Nicholas Meinhold | Announce PAX Aus presence via social channels and Steam dev log. |
| Press kit preparation | Sep 2026 | Nicholas Meinhold | Prepare downloadable press kit: high-res screenshots, trailer, logo, one-sheet, key art, studio bio, contact info. |
| GCAP attendance | Early Oct 2026 | Nicholas Meinhold | Attend Game Connect Asia Pacific (developer conference, same week as PAX). Network with publishers, media, and other Australian developers. |
| PAX Aus demo | Oct 9–11, 2026 | Nicholas Meinhold | Playable demo on the show floor. Players experience the full loop: enter the world, meet other players, solve coding challenges, interact with Clawd. Collect player feedback and email signups. |
| Post-PAX recap | Oct 2026 | Nicholas Meinhold | Dev log covering PAX experience, player feedback, media coverage, and next steps. |
...
| **AI API cost escalation** — Clawd uses Claude API, costs could increase with player volume | Medium | Currently using Claude Haiku 4.5 (cost-effective model). Responses are shared across all players in a room (not per-player). Can implement rate limiting, response caching, or switch to smaller models if costs exceed budget. Bot architecture is model-agnostic. |
...
|---|---|---|---|---|---|
| **Close of Contracting** | Jun 2026 | Jun 2026 | Sign PGA, provide solicitor letter, send NFSA Deed | Nicholas Meinhold | PGA fully executed. Solicitor letter and NFSA Deed submitted. 80% payment received. |
| **M1: Game Loop & Persistence** | Apr 2026 | Jun 2026 | Progression system (challenge completion tracking, scores, stars). Challenge persistence (save/resume via Firebase). Enhanced Clawd tutoring (structured hints, grading rubric, difficulty-aware feedback). "I'm stuck" button with guided hints. | Nicholas Meinhold | Players can complete challenges, see their progress saved across sessions, and receive structured feedback from Clawd. All 23 existing challenges have completion tracking. Progression state persists in Firebase. |
| **M2: Sound Design** | May 2026 | Jun 2026 | Ambient music, interaction SFX (movement, terminal open, challenge submit, chat receive), chat notification sounds. Volume/mute UI control. | Nicholas Meinhold | Game has ambient audio and SFX for key interactions. Audio can be muted via UI control. Sound enhances game feel without being intrusive. |
| **M3: Onboarding & Rewards** | Jul 2026 | Aug 2026 | Onboarding tutorial (guided first-time experience). Points and rewards system (badges, achievements for milestones). Challenge difficulty balancing based on playtesting. | Nicholas Meinhold | New player can complete onboarding without external instruction. Players earn points/badges for completed challenges. Difficulty curve validated through at least 5 playtest sessions. |
| **M4: Polish & Accessibility** | Aug 2026 | Sep 2026 | UI/UX polish pass (menus, transitions). Keyboard-only navigation. Configurable text sizes. Color-blind-friendly palette. Performance optimisation and cross-platform testing. Screen Australia logo integration. | Nicholas Meinhold | Game passes accessibility checklist (keyboard nav, text sizing, colour contrast). Runs at stable 60fps on target hardware. SA logo displayed per Credits Policy. |
| **M5: PAX Aus Preparation** | Sep 2026 | Oct 2026 | PAX demo build (curated experience for show floor). Demo station setup documentation. Collect gameplay footage for post-event marketing. Prepare feedback collection mechanism. | Nicholas Meinhold | Standalone demo build tested on PAX hardware. Demo runs reliably for 3-day event without intervention. Setup can be completed by non-developer in under 10 minutes. |
| **M6: PAX Aus Demo (Event)** | Oct 9, 2026 | Oct 11, 2026 | Exhibit at PAX Aus. Collect player feedback. Network at GCAP. | Nicholas Meinhold | Demo exhibited at PAX Aus for all 3 days. Player feedback collected (minimum 50 responses). |
| **Delivery Date** | Nov 2026 | Nov 2026 | Final Cost Report. Acquittal report on SmartyGrants. Second solicitor opinion. Delivery materials per PGA. | Nicholas Meinhold | All delivery materials approved by Screen Australia. Final 20% payment received. |
