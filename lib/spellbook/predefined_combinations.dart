...
final Map<String, SpellEffect> predefinedCombinations = <String, SpellEffect>{
  comboKey(const [WordId.ignis, WordId.lumen]): const SpellEffect(
    id: 'blazing_sight',
    name: 'Blazing Sight',
  ...
  comboKey(const [WordId.tempus, WordId.libera]): const SpellEffect(
    id: 'time_unbound',
    name: 'Time Unbound',
  ...
  comboKey(const [WordId.crystallum, WordId.vinculum]): const SpellEffect(
    id: 'crystal_ward',
    name: 'Crystal Ward',
  ...
  comboKey(const [WordId.verum, WordId.oraculum]): const SpellEffect(
    id: 'oracle_truth',
    name: "Oracle's Truth",
  ...
  comboKey(const [WordId.ignis, WordId.muta, WordId.forma]): const SpellEffect(
    id: 'pyric_reshape',
    name: 'Pyric Reshape',
