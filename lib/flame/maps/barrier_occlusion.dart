...
/// positions (plus doorway lintel tiles) into a separate object layer where
/// each tile is an individual [SpriteComponent] in the World's priority sort.
///
/// This is a **fallback** for maps without an authored object layer. Maps
/// with construction tilesets (wall brush) have their object layer pre-built
/// by the editor and don't need this function.
///
...
TileLayerData buildObjectLayerFromBarriers({
  ...
  // Copy floor tiles at barrier positions.
  for (final (x, y) in barriers) {
