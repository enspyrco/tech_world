...
final simpleMaze = GameMap(
  ...
  barriers: _deduplicateBarriers([
    ...
    ..._generateVerticalWall(5, 6, 38,
        gap: 22), // Start at y=6 to avoid corner overlap
    ..._generateVerticalWall(44, 6, 38,
        gap: 22), // Start at y=6 to avoid corner overlap
    // Internal maze walls
...
// ---------------------------------------------------------------------------
// ASCII art maps - more complex maps defined visually for maintainability.
//
// Legend: . = open, # = barrier, S = spawn, T = terminal
// Each map is a 50x50 grid (gridSize from constants.dart).
// ---------------------------------------------------------------------------

/// The Library - a quiet study space with bookshelves forming reading aisles,
/// study nooks along the walls, and terminal stations at study desks.
...
/// The Workshop - a maker space with workbenches, tool racks along the walls,
/// and open collaboration areas with terminal stations.
...
// ---------------------------------------------------------------------------
// Helper functions for generating barrier patterns (used by original maps)
// ---------------------------------------------------------------------------
